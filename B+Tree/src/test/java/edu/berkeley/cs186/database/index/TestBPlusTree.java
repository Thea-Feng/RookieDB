...
//
        ...
        //      (    4        7         10        _   )
        //       /       |         |         \
        // (1 2 3 _) (4 5 6 _) (7 8 9 _) (10 11 12 _)
...
//        String leaf2 = "((3 (3 3)))";
//        String leaf3 = "((4 (4 4)))";
//        String sexp = String.format("%s", leaf0);
//        assertEquals(sexp, tree.toSexp());
    }
    ...
    public void testDeleteEverything(){
        ...
        for(int i = 0; i < 1000; i++)
            tree.put(new IntDataBox(1000-i), new RecordId(i, (short) i));
        for(int i = 0; i < 1000; i++)
            tree.remove(new IntDataBox(1000-i));
