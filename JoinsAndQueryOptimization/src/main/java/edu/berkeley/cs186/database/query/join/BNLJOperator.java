    ...
    private class BNLJIterator implements Iterator<Record>{
        ...
        private void fetchNextLeftBlock() {
            ...
            if (this.leftSourceIterator.hasNext()) {
                ...
                Schema s = leftsource.getSchema();
                this.leftBlockIterator = leftsource.getBlockIterator(this.leftSourceIterator, s, numBuffers - 2);
        ...
        private void fetchNextRightPage() {
            ...
            if (this.rightSourceIterator.hasNext()) {
                ...
                Schema s = rightsource.getSchema();
                this.rightPageIterator = rightsource.getBlockIterator(this.rightSourceIterator, s, 1);
        ...
        private Record fetchNextRecord() {
            ...
            //if(!rightSourceIterator.hasNext()) return null;
            while(true) {
                if (rightPageIterator.hasNext()) {
                    // case 1: there's a next right record, join it if there's a match
                    Record rightRecord = rightPageIterator.next();
                    if (compare(leftRecord, rightRecord) == 0) {
                        return leftRecord.concat(rightRecord);
                    }
                }
                // case 2: at the end of right page, but still have left pages to read
                ...
                // case 3: at the end of left block, need to fetch new block and reset right iterator
                    ...
                    // case 4: at the end of left block and also the end of right block but still have right page
                    ...
                    // case 5: at the end of left source and also the end of right source
                    else {
                        return null;
                    }
                }
